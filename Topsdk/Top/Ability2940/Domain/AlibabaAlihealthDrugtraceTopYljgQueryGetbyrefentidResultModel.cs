...
public class AlibabaAlihealthDrugtraceTopYljgQueryGetbyrefentidResultModel
{

    /*
        返回对象
    */
    private AlibabaAlihealthDrugtraceTopYljgQueryGetbyrefentidPUserEntInfoDto? model;
    ...
    */
    ...
    public AlibabaAlihealthDrugtraceTopYljgQueryGetbyrefentidPUserEntInfoDto? Model
    {
        get => model;
