...
public class AlibabaAlihealthDrugtraceTopYljgQueryListpartsResultModel
{

    /*
        返回对象
    */
    private AlibabaAlihealthDrugtraceTopYljgQueryListpartsPage? model;
    ...
    */
    ...
    public AlibabaAlihealthDrugtraceTopYljgQueryListpartsPage? Model
    {
        get => model;
